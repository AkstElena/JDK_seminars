...
public class Map extends JPanel {
 ...
 // проверяет координаты, по которым прошел щелчок и по какому направлению надо двигаться, чтобы было нужно количество значений
    ...
    private void showMessage(Graphics g) {
        ...
        switch (gameStateType){
            case STATE_DRAW: g.drawString(MSG_DRAW, 180, getHeight() / 2 + 60); break;
            case STATE_WIN_HUMAN: g.drawString(MSG_WIN_HUMAN, 20, getHeight() / 2 + 60); break;
            case STATE_WIN_AI: g.drawString(MSG_WIN_AI, 70, getHeight() / 2 + 60); break;
